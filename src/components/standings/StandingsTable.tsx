      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-white/5">
            ...
            <th className="px-4 py-2.5 text-center section-title">{t("w")}</th>
            <th className="px-4 py-2.5 text-center section-title">{t("l")}</th>
            <th className="px-4 py-2.5 text-center section-title">{t("pf")}</th>
            <th className="px-4 py-2.5 text-center section-title">{t("pa")}</th>
            <th className="px-4 py-2.5 text-center section-title">{t("diff")}</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-white/5">
          ...
          {standings.length === 0 && (
            <tr><td colSpan={7} className="px-4 py-8 text-center text-gray-500 text-sm">{t("noMatchesYet")}</td></tr>
          )}
        </tbody>
      </table>
    </div>
